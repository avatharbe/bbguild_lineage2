<?php
/**
 * bbGuild Lineage 2 plugin - Data seeding migration
 *
...
class data extends \phpbb\db\migration\container_aware_migration
{
	...
	public function seed_game_data()
	{
		...
		$installer->install($this->get_table_names(), 'lineage2', 'Lineage 2', '', '', 'us');
	}

	public function remove_game_data()
	{
		$installer = $this->get_installer();
		$installer->uninstall($this->get_table_names(), 'lineage2', 'Lineage 2');
	}
